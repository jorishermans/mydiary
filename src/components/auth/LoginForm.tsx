...
import Icon from './undraw_Online_everywhere_re_n3lr.svg';
import { makeStyles } from '@material-ui/core/styles';
import useAuth from './useAuth';

import FissionIcon from './FissionIcon';
                ...
                <Grid container={true} justify={'center'} alignItems={'center'}>
                    <Grid item={true} xs={12} sm={10} md={7}>
                        <CardMedia
                            ...
                            image={Icon}
                            title="My Dairy — Web-Native Dairy application"
                        />
                    </Grid>
                    <Grid item={true} sm={8} md={6} lg={3}>
                        <Box px={2} pb={2} className={classes.card}>
                            <CardContent>
                                <Typography variant={'h2'} component={'h1'} className={classes.heading} >My Dairy</Typography>
                                <Typography
                                    variant={'h5'}
                                    component={'h2'}
                                    gutterBottom={true}
                                ...
                                >
                                    A web-native dairy application
                                </Typography>
                                <Button
                                    variant={'contained'}
                                    color={'primary'}
